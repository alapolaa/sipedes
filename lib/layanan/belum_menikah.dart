...
class BelumMenikah extends StatefulWidget {
  @override
  _BelumMenikahState createState() => _BelumMenikahState();
}

class _BelumMenikahState extends State<BelumMenikah> {
  ...
  TextEditingController statusPernikahanController = TextEditingController();
  ...
  Future<void> _submitForm() async {
    ...
    bool success = await apiService.submitBelumMenikahForm(
    ...
    if (success) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Pengajuan surat keterangan belum menikah berhasil!')),
      );
      Navigator.push(
        context,
        MaterialPageRoute(
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Gagal mengajukan surat keterangan belum menikah!')),
      );
    }
  }
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 12.h),
              _buildTextField(statusPernikahanController, 'Status Pernikahan'),
