              ...
              return SingleChildScrollView(
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      6.0.height,
                      Text("Visi", style: AppFont.duapuluhbold),
                      6.0.height,
                      Text(visiMisi.visi, style: AppFont.nambelas),
                      20.0.height,
                      Text("Misi", style: AppFont.duapuluhbold),
                      6.0.height,
                      ...visiMisi.misi.map((misi) => Padding(
                        padding: EdgeInsets.symmetric(vertical: 4.h),
                        child: Text("• $misi", style: AppFont.nambelas),
                      )),
                      20.0.height,
                    ],
                  ),
